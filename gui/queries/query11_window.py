...
class Query11Window(BaseQueryWindow):

    def __init__(self, query_dao: QueryDAO, parent=None):
        super().__init__(query_dao, parent)
        self.setWindowTitle("Запрос 11 – Прошедшие испытания")
        self._load_filters()

    def _get_title(self) -> str:
        return "Запрос 11: Изделия, прошедшие испытания"
    ...
    def _load_filters(self):
        """Загружает списки лабораторий и категорий."""
        try:
    ...
    def _execute_query(self):
        ...
        data = self.query_dao.query11_tested_products(
            lab_id=lab_id,
        ...
        columns = ["Серийный №", "Вид изделия", "Категория", "Лаборатория", "Дата испытания", "Результат"]
