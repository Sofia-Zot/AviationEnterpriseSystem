...
class Query9Window(BaseQueryWindow):


    def __init__(self, query_dao: QueryDAO, parent=None):
        super().__init__(query_dao, parent)
        self.setWindowTitle("Запрос 9 – Бригады для изделия")

    def _get_title(self) -> str:
        return "Запрос 9: Бригады для изделия"
    ...
    def _execute_query(self):
        ...
        data = self.query_dao.query9_brigades_for_product(serial_number=serial_number)

        columns = ["Бригада", "Участок", "ФИО", "Профессия"]
